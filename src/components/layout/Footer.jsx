    ...
    <footer className="bg-[#031c2e] py-14 text-slate-300">
      <Container>
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1.3fr]">
          ...
          <div><h3 className="text-sm font-bold text-white">Quick Links</h3><nav aria-label="Footer navigation" className="mt-4 grid gap-2 text-sm"><Link to="/services">Services</Link><Link to="/portfolio">Portfolio</Link><Link to="/about">About Us</Link></nav></div>
